				...
				>
					...
					<div>
						...
						<div class="flex gap-2">
							<a href="" target="_blank" class="btn btn-outline btn-sm">Twitter</a>
							<a href="" target="_blank" class="btn btn-outline btn-sm">GitHub</a>
							<a href="" target="_blank" class="btn btn-outline btn-sm">Website</a>
						</div>
					</div>
				</div>
			</div>
