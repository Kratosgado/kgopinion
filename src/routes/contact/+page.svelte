  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
    <div>
      <div class="prose lg:prose-xl max-w-none">
        <p>Have questions, suggestions, or just want to say hello? We'd love to hear from you! Fill out the form, and we'll get back to you as soon as possible.</p>
    ...
    <div>
      {#if success}
        <div class="bg-success text-success-content p-6 rounded-lg">
          ...
          <button class="btn btn-sm mt-4" on:click={() => success = false}>Send Another Message</button>
        </div>
      {:else}
