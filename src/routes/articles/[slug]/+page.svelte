	...
	<main class="container mx-auto py-10 px-4">
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
			...
			<div class="lg:col-span-2">
				...
				{#if post.author}
					<div
						class="mt-8 p-6 bg-base-200 rounded-lg flex flex-col sm:flex-row gap-6 items-center sm:items-start"
					>
						<img
							src={post.author.avatar || '/favicon.png'}
							alt={post.author.name}
							...
							<div class="flex gap-2">
								{#if post.author.social?.twitter}
									<a
										...
										class="btn btn-sm btn-outline">Twitter</a
									>
								{/if}
								{#if post.author.social?.github}
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										class="btn btn-sm btn-outline">GitHub</a
									>
								{/if}
								{#if post.author.social?.linkedIn}
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										class="btn btn-sm btn-outline">LinkedIn</a
									>
								{/if}
							</div>
						</div>
													...
													<div class="flex-1">
														<div class="flex justify-between items-center mb-1">
															<div>
																...
																<span class="text-sm text-gray-500 ml-2"
																	>{reply.createdAt.toLocaleDateString()}</span
																>
															</div>
															<button
																class="btn btn-ghost btn-xs gap-1"
																on:click={() => likeComment(reply.id)}
															>
																<svg
																	xmlns="http://www.w3.org/2000/svg"
																	width="12"
